i18n.importData("en", {
    ...
    menu_toggle_cuff_title = "Cuff",
    menu_weapons_title = "Confiscate weapons",
    menu_force_player_get_in_car_title = "Seat",
    menu_force_player_get_out_car_title = "Unseat",
    menu_sz_create_title = "Speed Zone",
    menu_drag_player_title = "Drag",
    ...
    menu_custom_amount_radius_title = "Input Radius",
    menu_custom_amount_speed_title = "Input Speed",
    menu_create_spdzone_title = "Create Speed Zone",
    menu_dlt_spdzone_title = "delete Speed Zone",
